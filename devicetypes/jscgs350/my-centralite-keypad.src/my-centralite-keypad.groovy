 ...
 */
metadata {
	definition (name: "My Centralite Keypad", namespace: "jscgs350", author: "Mitch Pond") {
    ...
    tiles (scale: 2) {
        ...
        standardTile("beep", "device.beep", decoration: "flat", width: 3, height: 2) {
        ...
        main (["keypad"])
        details (["keypad","motion","tamper","Panic","temperature","beep","refresh","battery"])
    }
}
