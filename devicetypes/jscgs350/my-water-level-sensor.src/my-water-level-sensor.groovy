...
metadata {
	definition (name: "My Water Level Sensor", namespace: "jscgs350", author: "SmartThings") {
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"contact", type: "generic", width: 6, height: 4){
			tileAttribute ("device.contact", key: "PRIMARY_CONTROL") {
				attributeState "closed", label: 'Water OK', icon: "st.Outdoor.outdoor5", backgroundColor: "#79b821"
				attributeState "open", label: 'Water LOW!', icon: "st.Outdoor.outdoor5", backgroundColor: "#ff0000"
			}
		}        
		valueTile("battery", "device.battery", inactiveLabel: false, decoration: "flat", width: 3, height: 2) {
			state "battery", label:'${currentValue}% battery', unit:""
		}
        standardTile("refresh", "device.contact", width: 3, height: 2, inactiveLabel: false, decoration: "flat") {
