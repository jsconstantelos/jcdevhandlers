/**
 *  Aeon HEM1 (this DH version is set up for running on only batteries, no mains power)
 *
 ...
 */
metadata {
    definition (name: "My Aeon Home Energy Monitor (battery powered only)", namespace: "jscgs350", author: "SmartThings") 
{
