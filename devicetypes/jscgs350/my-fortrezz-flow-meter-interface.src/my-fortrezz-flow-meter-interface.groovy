...
metadata {
	...
	tiles(scale: 2) {
		...
		main (["waterState"])
		details(["gpm", "gpmTotal", "gpmLastUsed", "gallonHigh", "gpmHigh", "dayChart", "weekChart", "monthChart", "powerState", "temperature", "battery", "zeroTile", "configure", "chartCycle", "history"])
	}
}
