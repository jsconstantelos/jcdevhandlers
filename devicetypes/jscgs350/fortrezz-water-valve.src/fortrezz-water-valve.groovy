 ...
 */
metadata {
	definition (name: "Fortrezz Water Valve", namespace: "jscgs350", author: "SmartThings", ocfDeviceType: "oic.d.watervalve", runLocally: false, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
		capability "Actuator"
