 ...
 *
 *  My Z-Wave Window Sensor Version: v2
 *
 *  Updates:
 *  -------
 *  03-18-2016 : Initial commit
 *
 */

metadata {
	definition (name: "My Z-Wave Window Sensor", namespace: "jscgs350", author: "SmartThings") {
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"contact", type: "generic", width: 6, height: 4){
			tileAttribute ("device.contact", key: "PRIMARY_CONTROL") {
				attributeState "closed", label: 'closed', icon: "st.Home.home9", backgroundColor: "#79b821"
				attributeState "open", label: 'open', icon: "st.Home.home9", backgroundColor: "#ffa81e"
			}
		}        
