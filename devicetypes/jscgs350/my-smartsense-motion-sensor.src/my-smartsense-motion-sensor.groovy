...
metadata {
	definition(name: "My SmartSense Motion Sensor", namespace: "jscgs350", author: "SmartThings", runLocally: false, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, mnmn: "SmartThings", vid: "generic-motion") {
	...
	tiles(scale: 2) {
		...
		valueTile("battery", "device.battery", decoration: "flat", inactiveLabel: false, width: 2, height: 2) {
			state "battery", action: "configure.configure", label: '${currentValue}% battery', unit: ""
		}
